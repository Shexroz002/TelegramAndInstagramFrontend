...
import '../assistents/css/commiteupdate.css';
...
function comment_delete(){
    axios.delete(`http://127.0.0.1:8000/api/posts/comment/detail/${iscomment_id}`,
    {
...
function comment_edit(){
    if(ismessagea){
        ...
        axios.put(`http://127.0.0.1:8000/api/posts/comment/detail/${iscomment_id}`,
        data_send,
        {
            headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
        })
